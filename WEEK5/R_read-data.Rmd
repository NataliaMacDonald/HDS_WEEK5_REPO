...
```{r}
fev_data <- as_tibble(fev_data)
summary(fev_data)

### The summary function provides a quick overview of the tibble. It provides the heading and relevant descriptive statistics, mean, meadian, IQR range etc.
